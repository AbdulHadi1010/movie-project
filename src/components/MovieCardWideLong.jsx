...
"vote_count":24
  ...
  >
    ...
    <div className="font-bold absolute text-4xl text-left py-4 pl-2 top-16">Featured By Website</div>
        <div className="font-bold absolute text-4xl text-left py-4 pl-2 top-1/2">{item.title}
      <div className="font-semibold text-lg w-1/2 pt-4">{item.overview}</div>
        </div>
